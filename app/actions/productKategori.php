...
if(isset($_GET['id_sub'])){
    ...
    $kategory=_select_unique_result("select * from sub_kriteria where idSub_kriteria='$_GET[id_sub]'");
                        ...
                        <td>
                            <ul>
                                ...
                                <?php foreach ($SubKriteriaList as $sub): ?>
                                    <li>
                                        <a href="<?php echo "?id=$_GET[id]&id_sub=$sub[idSub_kriteria]" ?>"><?php echo $sub['namaSubKriteria'] ?></a>
                                    </li>
                                <?php endforeach; ?>
                            </ul>
                        </td>
